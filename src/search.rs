...
mod tests {
    ...
    #[test]
    fn test_search_empty_query_matches_all() -> crate::error::Result<()> {
    ...
    #[test]
    fn test_search_known_subject_returns_results() -> crate::error::Result<()> {
        let (exercises, _) = load_all_exercises()?;
    ...
    #[test]
    fn test_search_filter_subject_limits_results() -> crate::error::Result<()> {
        let (exercises, _) = load_all_exercises()?;
    ...
    #[test]
    fn test_search_results_sorted_by_score_descending() -> crate::error::Result<()> {
        let (exercises, _) = load_all_exercises()?;
